package com.mirco.notes.auth.configuration;
...
public class AuthConfig {
    ...
    public final ISystemUserRepository iSystemUserRepository;

    public AuthConfig(ISystemUserRepository iSystemUserRepository) {
